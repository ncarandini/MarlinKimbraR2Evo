...
#define CUSTOM_MACHINE_NAME "R2EvoI"
...
#define X_MAX_POS 230 //250
#define X_MIN_POS -9  //0
#define Y_MAX_POS 350  //350
#define Y_MIN_POS -27  //0
#define Z_MAX_POS 260  //260
#define Z_MIN_POS 0
#define E_MIN_POS 0
...
#define X_PROBE_OFFSET_FROM_EXTRUDER 23      // Probe on: -left +right
#define Y_PROBE_OFFSET_FROM_EXTRUDER 36       // Probe on: -front +behind
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.5     // -below (always!)per alzare il nozzle alzare i valori ( a -6 il nozzle è più alto che a -7)

//#define Z_RAISE_BEFORE_HOMING 20            // (in mm) Raise Z before homing (G28) for Probe Clearance.
                                              // Be sure you have this distance over your Z_MAX_POS in case

#define Z_RAISE_BEFORE_PROBING 8       // much the extruder will be raised before travelling to the first probing point.
